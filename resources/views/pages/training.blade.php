...
<div class="container">
    <div class="container-fluid py-4">
        ...
        <div class="card px-3 py-3">
          <div class="d-lg-flex">
            <div>
            <h5 class="mb-0">All Trainings</h5>
         
            </div>
            <div class="ms-auto my-auto mt-lg-0 mt-4 mb-2">
            <div class="ms-auto my-auto">
            <button class="btn bg-gradient-primary btn-sm mb-0 mr-2"  data-bs-toggle="modal" data-bs-target="#newEmp" style="margin-right: 5px;">+&nbsp; New Training</a>
