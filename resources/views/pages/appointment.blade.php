...
<div class="container">
    <div class="container-fluid py-4">
        ...
        <div class="card px-3 py-3">
          <div class="d-lg-flex">
            <div>
            <h5 class="mb-0">All Apppointments</h5>
    ...
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      ...
      <div class="modal-body">
        <form action="{{route('appointment.store')}}" method="post" enctype="multipart/form-data">
          ...
          <div class="input-group input-group-static mb-4 my-3">
            <input type="title" name="title" class="form-control" id="">
          </div>
          <div class="input-group input-group-static mb-4 my-3">
...
function fetchRecord(id){
  ...
  $.ajax({
    ...
    success:function(res){
      console.log(res)
      var html = `<form action="appointment/${id}/edit" method="post" enctype="multipart/form-data">
                    @csrf`;
