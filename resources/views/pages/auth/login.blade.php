        ...
        <div class="container">
          <div class="row">
            <div class="col-6 d-lg-flex d-none h-100 my-auto pe-0 position-absolute top-0 start-0 text-center justify-content-center flex-column">
              <div class="position-relative bg-gradient-primary h-100 m-3 px-7 border-radius-lg d-flex flex-column justify-content-center" style="background-image: url('../assets/img/illustrations/cocoa-back.jpg'); background-size: cover;">
              </div>
            </div>
                ...
                <div class="card-body">
                  <form role="form" method="post" action="{{route('login.user')}}">
                    ...
                    <div class="text-center">
                      <button type="submit" class="btn btn-lg btn-lg w-100 mt-4 mb-0" style="background-image: linear-gradient(195deg, #805d75 0%, #fddb50 100%)">Sign In</button>
                    </div>
                  </form>
                </div>
