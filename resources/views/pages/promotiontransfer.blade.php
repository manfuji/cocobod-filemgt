...
<div class="container">
    <div class="container-fluid py-4">
        ...
        <div class="card px-3 py-3">
          <div class="d-lg-flex">
            <div>
            <h5 class="mb-0">All Promotions & Transfers</h5>
         
            </div>
            <div class="ms-auto my-auto mt-lg-0 mt-4 mb-2">
            <div class="ms-auto my-auto">
            <button class="btn bg-gradient-primary btn-sm mb-0 mr-2"  data-bs-toggle="modal" data-bs-target="#newEmp" style="margin-right: 5px;">+&nbsp; New Appointment</a>
...
<div class="modal-dialog mt-lg-10">
  <div class="modal-content">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      ...
      <div class="modal-body">
        <form action="{{route('promotrans.store')}}" method="post" enctype="multipart/form-data">
          @csrf
...
<div class="modal fade" id="EditEmp" tabindex="-1" aria-hidden="true">
  <div class="modal-dialog mt-lg-10">
    <div class="modal-content">
      <div class="modal-header">
      <h5 class="modal-title" id="ModalLabel">Edit Promotion & Transfer</h5>
      <i class="material-icons ms-3">add</i>
      <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
        <div class="modal-body">
...
function fetchRecord(id){
  console.log(id)
  $.ajax({
    url:`promtrans/${id}/edit`,
    data:{id},
    success:function(res){
      console.log(res)
      var html = `<form action="promtrans/${id}/edit" method="post" enctype="multipart/form-data">
                    @csrf`;
    ...
    success:function(res){
      ...
      var html = `<div class="row">`;
       html += `<div class="info-bottom">
          ...
          html += `<div class="info-bottom">
            <p>Description</p>
            <p class="mb-0"><strong>${res['description']??'No Description'}</strong></p>
          </div>`;
