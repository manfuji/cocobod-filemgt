...
<div class="modal-dialog mt-lg-10">
  <div class="modal-content">
    ...
    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      ...
      <div class="modal-body">
        <form action="{{route('application.store')}}" method="post" enctype="multipart/form-data" pattern="^[a-zA-Z]+$">
          @csrf
          ...
          <div class="input-group input-group-static mb-4 my-3">
            <input type="text" name="title" class="form-control" id="" pattern="^[a-zA-Z]+$">
          </div>
          <div class="input-group input-group-static mb-4 my-3">
