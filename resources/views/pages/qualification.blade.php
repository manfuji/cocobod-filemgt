    ...
    <div class="container">
        <div class="container-fluid py-4">
            ...
            <div class="card px-3 py-3">
              <div class="d-lg-flex">
                <div>
                <h5 class="mb-0">All Qualifications</h5>
             
                </div>
                <div class="ms-auto my-auto mt-lg-0 mt-4 mb-2">
                <div class="ms-auto my-auto">
                <button class="btn bg-gradient-primary btn-sm mb-0 mr-2"  data-bs-toggle="modal" data-bs-target="#newEmp" style="margin-right: 5px;">+&nbsp; New Qualification</a>
        ...
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
          ...
          <div class="modal-body">
            ...
            <div class="input-group input-group-dynamic my-3">
              ...
              <input class="form-control" type="text" name="title" onfocus="focused(this)" onfocusout="defocused(this)">
            </div>
            <div class="input-group input-group-dynamic my-3">
              <label class="form-label">Certificate</label>
              <input class="form-control" type="file" name="documents" onfocus="focused(this)" onfocusout="defocused(this)">
            </div>
...
function fetchRecord(id){
  console.log(id)
  $.ajax({
    url:`qualification/${id}/edit`,
    data:{id},
    success:function(res){
      console.log(res)
      var html = `<form action="qualification/${id}/edit" method="post" enctype="multipart/form-data">
                    @csrf`;
       html += `<div class="input-group input-group-static mb-4 my-3">
            <label for="exampleFormControlSelect1" class="ms-0">Select Employee</label>
            <select class="form-control" name="employee_id" id="exampleFormControlSelect1">
                <option value="1">Richard AG</option>             
            </select>
          </div>`;
          html += `<div class="input-group input-group-static mb-4 my-3">
            <input type="title" name="title" value="${res['title']}" class="form-control" id="">
          </div>`;
          html += `<div class="input-group input-group-static mb-4 my-3">
